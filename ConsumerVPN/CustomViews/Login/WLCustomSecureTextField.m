...
@implementation WLCustomSecureTextField
...
- (BOOL)becomeFirstResponder {
    ...
    if (success) {
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:WLLoginFieldSelectionNotification object:self userInfo:@{@"type":@"Password"}];
    }
